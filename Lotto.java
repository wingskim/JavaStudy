...
public class Lotto {
	...
	public static void main(String[] args) {
		...
		int count2=0;
		int count3=0;
		int[] strArr = new int[5]; // 7개의 int 배열 strArr 저장
		...
		//여기부터 버블정렬
			...
			System.out.println("");
		// 내 번호 뽑기
			int[] selArr = new int[5]; // 7개의 int 배열 strArr 저장
			...
			// 번호 뽑기
				...
				if(count==3) {
						count2++;
				//		System.out.println("3등 당첨번호 :"+list2);
				}
					else if(count==4) {
						count3++;
			//		System.out.println("2등 당첨번호 :"+list2);
					}
				...
				if(list.equals(list2)) {
					...
					System.out.println("3등 당첨자 수 : "+ count2 + "게임");
					System.out.println("2등 당첨자 수 : "+ count3 + "게임");
					break;
				}
			}
	}
